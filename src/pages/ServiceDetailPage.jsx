  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] px-6 py-16">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-orange-400 mb-6">{service.title}</h1>
                ...
                <div className='flex flex-col gap-6'>
                  <div className='flex gap-6'>
                    ...
                    <div className="md:w-1/2 flex flex-col justify-center">
                      {section.heading && (
                        <h3 className="text-2xl font-semibold text-orange-400 mb-4">{section.heading}</h3>
                      )}
                      <p className="text-md text-justify text-gray-700">{section.text}</p>
                    </div>
                  </div>

                <h3 className="text-4xl w-full mt-6 flex justify-center font-semibold text-orange-400 mb-4">{service.middleTest}</h3>
                </div>
